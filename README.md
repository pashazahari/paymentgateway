...
[Checkout CinetPay Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/cinetpay/)
...
[Checkout Razorpay Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/razorpay/)
route and middleware code will be same as version ^1.0, version ^2.0 will change only customer_charge and ipn_response method
...
[Checkout Mollie Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/mollie/)
route and middleware code will be same as version ^1.0, version ^2.0 will change only customer_charge and ipn_response method
...
[Checkout Flutterwave Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/flutterwave/)
...
[Checkout Paystack Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/paystack/)
...
## Payfast
[Checkout Payfast Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/payfast/)
...
## Cashfree
[Checkout Cashfree Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/cashfree/)
...
## Instamojo
[Checkout Instamojo Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/instamojo)
...
[Checkout Mercadopago Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/mercadopago/)
...
[Checkout Squareup Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/how-to-get-square-payment-gateway-api-credentials/)
...
[Checkout PayTabs Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/how-to-get-paytabs-payment-gateway-api-credentials/)
...
[Checkout BillPlz Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/how-to-setup-api-for-billplz-payment-gateway/)
...
[Checkout Zitopay Setup Documentation](https://digihust.com/docs/nexelit/payment-gateway-settings/zitopay-payment-gateway-setup)
...
[Checkout Toyyibpay Setup Documentation](https://docs.digihust.com/docs/nexelit/payment-gateway-settings/toyyibpay-payment-gateway-setup)
```php
...
## Setup For Pagali
[Checkout Pagali Setup Documentation](https://docs.digihust.com/docs/nexelit/payment-gateway-settings/pagali-payment-gateway-setup)
```php
...
[Checkout Authorize.nnt Setup Documentation](https://docs.digihust.com/docs/nexelit/payment-gateway-settings/authorize-payment-gateway-setup)
```php
...
[Checkout TransactionCloud Setup Documentation](https://docs.digihust.com/docs/nexelit/payment-gateway-settings/transaction-cloud-payment-gateway-setup)
```php
...
## Setup For Senangpay
[Senangpay Documentation](https://docs.digihust.com/docs/nexelit/payment-gateway-settings/how-to-configure-senangpay/)
